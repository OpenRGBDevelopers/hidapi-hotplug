%global _name hidapi-hotplug

Name:           hidapi-hotplug
Version:        0.15.0
Release:        3%{?dist}
Summary:        Library for communicating with USB and Bluetooth HID devices (hotplug enabled)
...
%package devel
Summary: Development files for hidapi-hotplug
Requires: %{name}%{?_isa} = %{version}-%{release}

%description -n hidapi-hotplug-devel
This package contains development files for hidapi-hotplug which provides access to
USB and Bluetooth HID-class devices.

%package -n mingw32-hidapi-hotplug
Summary:        %{summary}
Obsoletes:      mingw32-hidapi-hotplug-static < 0.11.2-6

%description -n mingw32-hidapi-hotplug %_description

%package -n mingw64-hidapi-hotplug
Summary:        %{summary}
Obsoletes:      mingw64-hidapi-hotplug-static < 0.11.2-6

%description -n mingw64-hidapi-hotplug %_description
...
%files devel
%{_includedir}/hidapi-hotplug
%{_libdir}/cmake/hidapi-hotplug
%{_libdir}/libhidapi-hotplug-hidraw.so
%{_libdir}/libhidapi-hotplug-libusb.so
%{_libdir}/pkgconfig/hidapi-hotplug-hidraw.pc
%{_libdir}/pkgconfig/hidapi-hotplug-libusb.pc

%files -n mingw32-hidapi-hotplug
%doc AUTHORS.txt README.md LICENSE*.txt
%{mingw32_libdir}/cmake/hidapi-hotplug
%{mingw32_bindir}/libhidapi-hotplug.dll
%{mingw32_libdir}/libhidapi-hotplug.dll.a
%{mingw32_libdir}/pkgconfig/hidapi-hotplug.pc
%{mingw32_includedir}/hidapi-hotplug

%files -n mingw64-hidapi-hotplug
%doc AUTHORS.txt README.md LICENSE*.txt
%{mingw64_libdir}/cmake/hidapi-hotplug
%{mingw64_bindir}/libhidapi-hotplug.dll
%{mingw64_libdir}/libhidapi-hotplug.dll.a
%{mingw64_libdir}/pkgconfig/hidapi-hotplug.pc
%{mingw64_includedir}/hidapi-hotplug

%changelog
* Wed Jan 21 2026 Adam Honse <calcprogrammer1@gmail.com> - 0.15.0-1
- Forked existing hidapi spec to build hidapi-hotplug
